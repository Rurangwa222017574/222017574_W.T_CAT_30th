...
session_start();
  ...
  if(isset($_POST['submit'])){
    ...
    if($amount <= $row['amount']){
        $insert = mysqli_query($con, "INSERT INTO loan_payments VALUES(null, $id,'$date', $amount, $userid)");
        ...
        echo "<script>alert('TOO MUCH AMOUNT!');</script>";
        //header("Location: payloan.php?id=".$id);
    }
  }
?>
<!DOCTYPE html>
  ...
  <section id="heros" class="bg-light">
      <div class="container">
        <div class="row  mt-5 pt-4">
          ...
          <h3 class="text-center mb-4">Loan Payment</h3>
            <div class="card shadow mb-5 bg-white">
                    <div class="card-body">
                            <div class="card-title mb-4"><h5>Payment form</h5></div>
                           <p>
                            ...
                            <form id="loanApplicationForm" action="" method="post">
                                ...
                                <input type="number" id="amount" name="amount" class="form-control mb-2 shadow" placeholder="Required amount" autofocus>

                                <button type="submit" name="submit" class="form-control btn btn-primary mb-2 m-2 shadow">PAY</button>
                            </form>
