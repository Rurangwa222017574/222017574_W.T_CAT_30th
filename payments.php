...
session_start();
  ...
  $getLoans = mysqli_query($con, "SELECT * FROM loan_payments WHERE user_id = $userid");
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <section id="heros" class="bg-light">
      <div class="container">
        <div class="row  mt-5 pt-4">
          ...
          <div class="col-md-10">
          <h3 class="text-center mb-4">My payment history</h3>
                              ...
                              while($rows = mysqli_fetch_array($getLoans)){?>
                                <tr>
                                    ...
                                    <td>
                                        <?php 
                                        $id = $rows['loan_id'];
                                        $gett =mysqli_fetch_array(mysqli_query($con, "SELECT * FROM loan_applications WHERE id = $id"));
                                            echo $gett["description"]; 
                                        ?>
                                    </td>
