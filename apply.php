...
session_start();
  ...
  if(isset($_POST['submit'])){
    ...
    $insert = mysqli_query($con, "INSERT INTO loan_applications VALUES(null, '$description',$amount,0,0,'$date', $userid ,null)");
    ...
    <section id="heros" class="bg-light">
      <div class="container">
        <div class="row  mt-5 pt-4">
          ...
          <h3 class="text-center mb-4">Loan application</h3>
            <div class="card shadow mb-5 bg-white">
                    <div class="card-body">
                        <div class="card-title mb-4"><h5>Application form</h5></div>
                            <!-- Loan Application Form -->
                            <form id="loanApplicationForm" action="apply.php" method="post">
                                
                                <label for="amount">Amount:</label>
                                <input type="number" id="amount" name="amount" class="form-control mb-2 shadow" placeholder="Required amount">

                                <label for="description">Description:</label>
                                <input type="text" id="description" name="description" class="form-control mb-2 shadow" placeholder="Loan description">

                                <button type="submit" name="submit" class="form-control btn btn-primary mb-2 m-2 shadow" placeholder="Enter your email">Submit</button>
                            </form>
